...
var order_routes = function (app) {
    ...
    app.get('/users/:user_id/current-orders', authentication_1.default, currentOrders);
    app.get('/users/:user_id/current-orders', authentication_1.default, completedOrders);
};
