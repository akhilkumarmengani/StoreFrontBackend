        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        conn = _a.sent();
                        return [4 /*yield*/, conn.query(sql, [order.productId, order.quantity, order.userId, order.status])];
                    case 3:
                        result = _a.sent();
                        conn.release();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        return [4 /*yield*/, conn.query(sql, [order.userId, order.productId, order.quantity, order.status])];
                    case 2:
                        result = _a.sent();
                        conn.release();
                        return [2 /*return*/, result.rows[0]];
